...
function get_geocode($address){
    ...
    $url ="https://maps.googleapis.com/maps/api/geocode/json?address={$address}&key=AIzaSyAeUOWcoif1SDM3L9EuNkn5qHs070bKQPQ";
...
echo json_encode(get_geocode('Durham Cathedral'));
?>
